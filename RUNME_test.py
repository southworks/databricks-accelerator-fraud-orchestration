...
repo_root = "/Workspace" + notebook_path.rsplit("/", 1)[0]
workspace_csv_path = f"{repo_root}/DFF_Ruleset.dmn"
dbfs_csv_path = "dbfs:/tmp/dff/DFF_Ruleset.dmn"

dbutils.fs.cp(f"file://{workspace_csv_path}", dbfs_csv_path)

# COMMAND ----------

NotebookSolutionCompanion().deploy_compute(job_json, run_job=True)
